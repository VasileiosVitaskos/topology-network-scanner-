...
Every connector — whether it reads files, SSH into Cisco,
or pulls from mock API — must implement these methods.
...
class BaseConnector(ABC):
    ...
    def get_topology(self) -> List[Dict]:
        ...
        For SSH: parsed from "show arp" / "show cdp neighbors"
        For files: extracted from log source/dest IPs
        For mock: synthetic topology
        """
        pass
