    ...
    <div>
      ...
      {health.total_events > 0 && (
        <div className="health-bar">
          ...
          <div className="health-stat">
            <div className="health-value" style={{ color: health.denied_events > 5 ? '#ef4444' : undefined }}>
              {health.denied_events || 0}
            </div>
            <div className="health-label">Denied</div>
          </div>
          <div className="health-stat">
            <div className="health-value" style={{ color: health.cross_segment_events > 0 ? '#f59e0b' : undefined }}>
        ...
        <div className="gates-section">
          ...
          {showGates && (result.betti_h0 !== undefined) && (
            <div style={{
              ...
              <span style={{ color: result.betti_h2 > 0 ? '#ef4444' : undefined }}>
                β₂={result.betti_h2}
              </span>
              <span style={{ color: result.betti_h3 > 0 ? '#ef4444' : undefined }}>
                β₃={result.betti_h3}
              </span>
...
function statusColor(s) {
  ...
  if (s.includes('suspicious') || s.includes('mid')) return '#f59e0b';
  return '#34d399';
}
