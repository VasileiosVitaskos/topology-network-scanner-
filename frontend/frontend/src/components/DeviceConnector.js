      ...
      <div className="modal-content" onClick={e => e.stopPropagation()}>
        ...
        <div className="modal-body">
          <div className="field-row">
            <label style={{ width: 80, color: '#2dd4bf' }}>IP/Host</label>
            <input
          ...
          <div className="field-row">
            <label style={{ width: 80, color: '#2dd4bf' }}>Username</label>
            <input
              className="field-input"
              placeholder="admin"
              value={user}
          ...
          <div className="field-row">
            <label style={{ width: 80, color: '#2dd4bf' }}>Password</label>
            <input
              className="field-input"
              type="password"
              placeholder="••••••••"
          ...
          <div className="field-row">
            <label style={{ width: 80, color: '#2dd4bf' }}>Device</label>
            <select
              className="field-input"
              value={deviceType}
